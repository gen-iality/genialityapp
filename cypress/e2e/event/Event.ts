...
describe('Create event', () => {
  ...
  it('should create registry parameters ', () => {
    cy.wait(5000)
    cy.scrollTo('top')
    cy.get('.ant-menu-submenu-title').eq(3).trigger('mouseover')
    cy.wait(2000)
    ...
    cy.wait(2000)
    cy.get('input[name="label"]').eq(1).type('Cédula')
    cy.get('.ant-select-selector').click()
    cy.wait(2000)
    cy.get('.ant-select-item.ant-select-item-option').eq(6).click()
    ...
    cy.get('.ant-btn.ant-btn-primary').eq(2).click()
    cy.wait(2000)
    cy.get('input[name="label"]').eq(1).type('Codigo de area')
    cy.get('.ant-select-selector').click()
    cy.wait(2000)
    ...
    cy.get('.ant-btn.ant-btn-primary').eq(2).click()
    cy.wait(2000)
    cy.get('input[name="label"]').eq(1).type('Telefono')
    cy.get('.ant-select-selector').click()
    cy.wait(2000)
    cy.get('.ant-select-item.ant-select-item-option').eq(6).click()
    cy.get('#mandatoryModal').click()
    ...
    cy.get('.ant-btn.ant-btn-primary').eq(2).click()
    cy.wait(2000)
    cy.get('input[name="label"]').eq(1).type('Pais')
    cy.get('.ant-select-selector').click()
    cy.wait(2000)
    ...
    cy.get('.ant-btn.ant-btn-primary').eq(2).click()
    cy.wait(2000)
    cy.get('input[name="label"]').eq(1).type('Ciudad')
    cy.get('.ant-select-selector').click()
    cy.wait(2000)
    cy.get('.ant-select-item.ant-select-item-option').eq(3).click()
    cy.get('#mandatoryModal').click()
  ...
  it('it must register in the event with the parameters when it is a user is already registered', () => {
    ...
    cy.get('input[type=email]').eq(1).type(emailNoRegister)
    cy.get('input[type=password]').eq(0).type(clave)
