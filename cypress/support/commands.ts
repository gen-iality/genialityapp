...
Cypress.Commands.add('logout', () => {
  ...
  cy.get('.ant-dropdown-menu-title-content').eq(6).click()
  cy.wait(2000)
  cy.get('button')
...
Cypress.Commands.add('logoutWithOutEvent', () => {
  ...
  cy.get('.ant-dropdown-menu-title-content').eq(5).click()
  cy.wait(2000)
  cy.get('button')
    .should('have.class', 'ant-btn ant-btn-default ant-btn-dangerous')
    .eq(5)
...
Cypress.Commands.add('correctFields', () => {
  cy.get('#cedula').clear().type('235235532')
  cy.get('#codigoDeArea').clear().type('+57')
  cy.get('#telefono').clear().type('300 978 5555')
