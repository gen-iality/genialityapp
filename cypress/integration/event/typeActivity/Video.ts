describe('Video activity', () => {
  ...
  it('it should create video activity', () => {
    cy.visitEvent();
    ...
    cy.get('button.ant-btn.ant-btn-primary')
      ...
      .click();
    cy.wait(2000);
    cy.get('input[name="name"]').type('Actividad  Video Cypress ' + id);
    ...
    cy.get('.ant-btn.ant-btn-primary')
      ...
      .click();
    cy.wait(1000);
    cy.get('#url').type('https://www.youtube.com/watch?v=Zdg-7mnXdaM');
    cy.get('.ant-btn.ant-btn-primary')
      .eq(3)
      .click();
    cy.wait(3000);
  ...
  it('it should see the activity on the landing page', () => {
    ...
    cy.get('.titulo').should('contain', 'Actividad  Video Cypress ' + id);
    cy.get('.ant-ribbon-wrapper')
      .eq(1)
      .click();
    cy.wait(4000);
  ...
  it('it should create upload video activity', () => {
    cy.visitEvent();
    cy.openUserMenu();
    cy.get('.ant-dropdown-menu-title-content')
      .eq(2)
    ...
    cy.get('button.ant-btn.ant-btn-primary')
      ...
      .click();
    cy.wait(2000);
    cy.get('input[name="name"]').type('Actividad  Video Subido Cypress ' + id);
    const filePath = 'cypress.jpg';
    cy.get("input[type='file']").attachFile(filePath);
    cy.wait(1000);
    cy.scrollTo('top');
    ...
    cy.get('.ant-btn.ant-btn-primary')
      ...
      .click();
    cy.wait(1000);
    const fileVideoPath = 'video.mp4';
    cy.get("input[type='file']")
      .eq(1)
      .attachFile(fileVideoPath);
    cy.wait(15000);
    cy.get('.ant-btn.ant-btn-primary')
      .eq(3)
      .click();
