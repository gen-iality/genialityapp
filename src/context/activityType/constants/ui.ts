...
export const activityContentValues: {
  [key in ActivityType.DeepUIKey]: ActivityType.ContentValue
} = {
...
const urlInputForms: {
  [key in keyof typeof activityContentValues]?: ActivityType.FormUI
} = {
  url: {
...
const htmlForm: ActivityType.FormUI = {
  ...
  title: 'HTML Código',
  description:
    'Este tipo de contenido te permiterá subir código HTML que ser visualizará como un curso',
  image:
    'https://firebasestorage.googleapis.com/v0/b/eviusauth.appspot.com/o/Evius_type_activity%2Fmeeting.png?alt=media&token=02a6259b-3c30-436f-b0b0-f4cf1eecdfd6',
}
...
export const formWidgetFlow: ActivityType.MainUI = {
  ...
  cards: [
    ...
    },
    {
      ...
      MainTitle:
        'Crear reuniones interactivas y personalizadas con todo el poder de GEN.iality',
      title: 'Reunión',
      description:
