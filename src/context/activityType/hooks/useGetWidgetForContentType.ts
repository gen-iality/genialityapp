...
export function useGetWidgetForContentType(
  type: ActivityType.GeneralTypeValue,
): ActivityType.CardUI | ActivityType.FormUI | null {
  switch (type) {
    ...
    case activityContentValues.url:
      return (formWidgetFlow.cards[2].cards as ActivityType.CardUI[])[0]
        .form as ActivityType.FormUI
    case activityContentValues.file:
      return (formWidgetFlow.cards[2].cards as ActivityType.CardUI[])[1]
        .form as ActivityType.FormUI
    default:
      return null
  }
