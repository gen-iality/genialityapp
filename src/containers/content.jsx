...
const socialZone = loadable(() =>
  import("../components/socialZone/socialZone")
);
...
const EventFinished = loadable(() =>
  import("../components/eventFinished/eventFinished")
);
const LoginWithCode = loadable(() =>
  import("../components/AdminUsers/WithCode")
);
const NoMatchPage = loadable(() =>
  import("../components/notFoundPage/noMatchPage")
);
