        ...
        <Col xs={24} sm={24} md={8} lg={8} xl={8} xxl={8}>
          <List
            ...
            <List.Item style={{ border: 'none' }}>
              <a target='_blank' href='https://magnetic.com.co/' style={{ color: '#fff' }}>
                Inicio
              </a>
            </List.Item>
            <List.Item style={{ border: 'none' }}>
            ...
            <List.Item style={{ border: 'none' }}>
              <a target='_blank' href='https://www.instagram.com/magnetic.experiencias/' style={{ color: '#fff' }}>
                Casos de éxito
              </a>
            </List.Item>
            <List.Item style={{ border: 'none' }}>
              <a target='_blank' href='https://magneti.com.co/contact/' style={{ color: '#fff' }}>
                Solicitar demo
              </a>
            </List.Item>
          </List>
      ...
      <Row gutter={[0, 8]} wrap justify='space-between'>
        ...
        <Col
          ...
          <Space wrap>
            ...
            <a href='https://www.instagram.com/magnetic.experiencias/' target='_blank' style={{ color: '#fff' }}>
              <InstagramFilled style={{ fontSize: '35px' }} />
            </a>
            <a href='https://www.linkedin.com/in/magnetic-sas-812744302/' target='_blank' style={{ color: '#fff' }}>
              <LinkedinFilled style={{ fontSize: '35px' }} />
            </a>
            <a href='https://www.youtube.com/@Magneticsas' target='_blank' style={{ color: '#fff' }}>
