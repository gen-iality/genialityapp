    ...
    return (
      <div className='columns event-rsvp'>
              ...
              <div className='columns is-mobile is-centered rsvp-where'>
                ...
                <div className='column is-8'>
                  ...
                  <span className='rsvp-location'>
                    {this.props.event.location && this.props.event.location.FormattedAddress}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className='column is-4'>
          <div className='box rsvp-send'>
            <div className='columns is-centered-is-multiline'>
              <div className='column'>
                <p className='rsvp-send-title'>
                  Seleccionados <span>{this.state.selection&&this.state.selection.length}</span>
                </p>
                <p>
                  {this.state.selection&&this.state.selection.map((el) => {
            ...
            <div className='column rsvp-send-users'>
              {this.state.selection&&this.state.selection.map((item, key) => {
                return (
        ...
        <Dialog
          ...
          title={'Confirmación'}
          content={<p>Se van a enviar {this.state.selection&&this.state.selection.length} invitaciones</p>}
