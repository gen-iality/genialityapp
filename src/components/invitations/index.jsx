                               ...
                               <span className="icon is-large has-text-grey">
                                ...
                                <div>
                                   <span className="icon is-large has-text-primary">
                                    ...
                                    <span>
                                        Ubicación del evento<br/>{this.props.event.location}
                                    </span>
                                </div>
                                <p>
                                ...
                                <div className="imgRsvp">
                                    <img src={this.state.item.image} alt={'Imagen Perfil'}/>
                                </div>
