          ...
          <div className='columns checkin-header'>
            ...
            <div className='column'>
              <div className='columns is-mobile is-multiline is-centered'>
                ...
                <div className='column is-narrow has-text-centered'>
                  <button className='button is-inverted' onClick={this.modalImport}>
                    Importar
                  </button>
                </div>
                <div className='column is-narrow has-text-centered'>
                          ...
                          <thead>
                            <tr>
                              ...
                              {extraFields.map((field, key) => {
                                return (
                                  <th key={key} className='is-capitalized'>
                                    {field.name}
                                  </th>
                                );
                              })}
...
const handleUsers = (list) => {
  ...
  list.map((user, key) => {
    ...
    return Object.keys(user.properties)
      .slice(0, 2)
      .map((field) => {
