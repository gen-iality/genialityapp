...
const UserStatusAndMenu = (props) => {
  ...
  let menu = (
      ...
      <Menu>
       ...
       {visible && <Menu.Item style={ItemStyle} onClick={()=> linkToTheMenuRouteS(window.location.toString().includes('organization')?`/create-event/${props.userEvent._id}/?orgId=${props.eventId}`:`/create-event/${props.userEvent._id}`)}>
