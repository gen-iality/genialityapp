...
import { ExclamationCircleOutlined, DeleteOutlined, EditOutlined, PlusCircleOutlined, SaveOutlined } from '@ant-design/icons';
          ...
          <Col>
            <Tooltip placement='topLeft' title='Editar'>
              <Button
                ...
                onClick={()=>{setEditStands(true); setViewModalColor(false); setNoValid(false);obtenerStand(record)}}
                icon={<EditOutlined />}
                type='primary'
                size='small'
              />
      ...
      <Row justify='center' wrap gutter={12}>
        <Col span={20}>
          ...
          <Card 
            ...
            extra={
              <Button 
                onClick={()=>{setEditStands(true);setColorStand("#2C2A29");setViewModalColor(false);setNoValid(false);obtenerStand(null)}} type="primary" icon={<PlusCircleOutlined />}
              >
                {'Agregar'}
              </Button>
            }
            ...
            <Modal title={selectedStand?"Editar stand":"Agregar stand"} visible={editStands} onOk={editStand}  onCancel={handleCancel}>
              <Form>
                ...
                <Form.Item label={<span style={{width:70}}>Color</span>}>        
                  ...
                  { viewModalColor &&  
                    <div style={{ position: 'fixed', top: '270px', right: '0px', bottom: '0px', left: '600px',zIndex:10000 }}>
