...
function ModalMembers(props) {
  ...
  async function saveUser(values) {
    ...
    if (props.editMember) {
      ...
      await PositionsApi.Organizations.addUser(organizationId, values.position_id, userId);
    } else {
      resp = await OrganizationApi.saveUser(organizationId, body);
      await PositionsApi.Organizations.addUser(organizationId, values.position_id, resp._id);
    }
