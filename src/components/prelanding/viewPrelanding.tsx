  ...
  if (!cEventContext.value?.styles) {
    return (
      <div
        ...
        <Spin tip='Cargando' size='large' indicator={<LoadingOutlined style={{ fontSize: '70px' }} />}></Spin>
      </div>
    );
  }
  moment.locale('en');
          ...
          <Row
            ...
            style={
              screens.xs || mobilePreview === 'smartphone'
                ? style.mobileBlockContainerStyle
                : style.desktopBlockContainerStyle
            }>
                ...
                {visibleSection('Descripción') && description?.length > 0 && (
                  <Col order={obtenerOrder('Descripción')} span={24}>
                    <Card
                      ...
                      bodyStyle={
                        screens.xs || mobilePreview === 'smartphone'
                          ? style.mobileBlockContentStyle
                          : desktopBlockContentStyle
                      }
                      style={{
                        boxShadow: shadow,
                        borderRadius: '20px',
