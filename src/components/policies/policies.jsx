    ...
    return (
      <div style={{ textaAlign: 'justify', padding: '0 150px' }}>
        ...
        <p>
          ...
          AND CRIMINAL RECORDS. Magnetic DISCLAIMS ALL LIABILITY TO ANY USE, MISUSE, UNLAWFUL USE OR UNAUTHORIZED USE OF
          ...
          If you wish to contact Magnetic by regular mail, the updated Magnetic physical addresses are available
          at:https://www.magnetic.co/contact. 3.3. Share with Friends Service The Services enable you to invite your
        ...
        <p>
          ...
          may send to us. We use such information to analyze trends, administer the Services, track users&apos;
          ...
          the purposes of the Services, Magnetic is a data processor. Magnetic&apos;s data processing addendum, which is
          available at:https://www.magnetic.co/privacy/dpa, applies to such processing. 15.1. Where we process your
          ...
          and improvements to yours and other users&apos; experience with our services. 15.2. In addition to the right
          ...
          protection laws, is available on the EU Commission&apos;s website
