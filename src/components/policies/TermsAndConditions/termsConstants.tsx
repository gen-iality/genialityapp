...
const termsSections = {
    ...
    content: (
      <Typography.Paragraph>
        <Typography.Paragraph>
          ...
          aceptando cualquier reglamento de uso, política o proceso que Magnetic actualice durante el uso de la misma.
        </Typography.Paragraph>
        <Typography.Paragraph>
          En caso de no estar de acuerdo, o no aceptas ninguno de estos términos, políticas, o reglas de uso, no podrás
          usar la plataforma, ni los servicios prestados por Magnetic.
        </Typography.Paragraph>
        <Typography.Paragraph>
          Al aceptar, te comprometes a utilizar Magnetic de manera ética y legal. No podrás utilizar la plataforma para
  ...
  SERVICE_DESCRIPTION: {
    ...
    content: (
      <Typography.Paragraph>
        Magnetic ofrece una plataforma basada en la web, usada para la gestión y ejecución de eventos virtuales, físicos
        e híbridos en toda clase de actividades organizadas por personas naturales y/o jurídicas, permitiendo llevar una
  ...
  PLATFORM_USAGE: {
    ...
    content: (
      <Typography.Paragraph>
        <Typography.Paragraph>
          El acceso a Magnetic podrá ser realizado por cualquier dispositivo con acceso a internet, como computadores,
        ...
        <Typography.Paragraph>
          Magnetic ha ejecutado diversas pruebas con el fin de garantizar la disponibilidad de la plataforma y los
          servicios que ella presta a los usuarios. No obstante, podrá presentar momentos de interrupción por labores de
          mantenimiento, errores de hardware/software u otras causas de fuerza mayor. En estos casos, Magnetic informará
          a los organizadores de manera oportuna los mantenimientos o errores causados por terceros.
        </Typography.Paragraph>
        <Typography.Paragraph>
          De acuerdo con lo anterior, Magnetic se exime de toda responsabilidad por posibles daños y/o perjuicios
          causados por la falta de disponibilidad o de continuidad del funcionamiento de los servicios prestados.
        </Typography.Paragraph>
      </Typography.Paragraph>
    ),
  },
  ...
  PLATFORM_ENTRY: {
    ...
    content: (
      <Typography.Paragraph>
        <Typography.Paragraph>
          Para acceder a Magnetic, contamos con 3 tipos de acceso para usuarios y organizadores a saber:
        </Typography.Paragraph>
        <Typography.Paragraph>
          ...
          actividades de experiencia masiva (bingos, networking, juegos, entre otros) Magnetic solicitará a los
          asistentes los siguientes datos básicos:
          <ul>
        ...
        <Typography.Paragraph>
          ...
          organizadores deberán enviar a Magnetic una base de datos de los asistentes que ingresarán al evento,
          permitiendo usar todos los servicios que haya contratado con Magnetic. Personas externas a esta base de datos
    ...
    content: (
      <Typography.Paragraph>
        ...
        <Typography.Paragraph>
          ...
          durante el evento. Terminado ese tiempo, Magnetic se encargará de bloquear cualquier acceso y/o registro de
        ...
        <Typography.Paragraph>
          ...
          landing y videos durante el tiempo que el organizador contrate con Magnetic o en su defecto por 30 días.
        </Typography.Paragraph>
        <Typography.Paragraph>
          Cualquier extensión otorgada estará sujeta a la aprobación y términos adicionales acordados entre el
          organizador y Magnetic
        </Typography.Paragraph>
        <Typography.Paragraph>
  ...
  FEES_AND_PAYMENTS: {
    ...
    content: (
      <Typography.Paragraph>
        ...
        <Typography.Paragraph>
          En caso de cualquier retraso en el pago de los servicios prestados, Magnetic tendrá el derecho de suspender el
  ...
  TERMS_CONDITIONS_MODIFICATIONS: {
    ...
    content: (
      <Typography.Paragraph>
        Magnetic podrá modificar el uso de los servicios de la plataforma en cualquier momento. En estos casos,
...
export const termsTitle: TLegalTitle = 'TÉRMINOS Y CONDICIONES PLATAFORMA Magnetic';

export const termsParagraph: TLegalParagraphs =
  'Gracias por elegir a Magnetic como la plataforma de eventos virtuales, físicos e híbridos. Como empresa queremos que tus eventos tengan la mejor experiencia y calidad que te mereces, por eso te invitamos a leer estos términos y condiciones de uso de nuestra plataforma con el fin de ofrecerte lo mejor para tus eventos.';
