...
export const termsContent: ITermsContent = [
	{
		title: <Typography.Title level={5}>{termsAnchor[0].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[1].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[2].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[3].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[4].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[5].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[6].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[7].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[8].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[9].title}</Typography.Title>,
	...
	{
		title: <Typography.Title level={5}>{termsAnchor[10].title}</Typography.Title>,
