...
const Certificado: FC<CertificatesProps> = (props) => {
	...
	const {
		...
		image,
		restoreImage,
	} = useCrudCertificate(certificateId);
	...
	if (isLoadingCertificate)
		return (
			<Row style={{ height: '500px' }} align='middle' justify='center'>
				<Loading />
			</Row>
		);
	...
	return (
		<Form form={form} onFinish={onSubmit} {...formLayout}>
						...
						<Row wrap gutter={[16, 8]}>
							...
							<Col>
								<Button
									type='primary'
									onClick={() => {
										generate(props.event, certificatesRow, image);
									}}>
									{'Generar'}
								</Button>
							</Col>
			...
			<Row style={{ padding: '30px' }} justify='center' wrap gutter={[12, 22]}>
				<Col span={24}>
					<Row wrap gutter={[16, 16]}>
						<Col span={12}>
							<Form.Item
								...
								name={'name'}>
								<Input name={'name'} placeholder={'Nombre del certificado'} />
							</Form.Item>
						</Col>
						<Col span={12}>
							<Form.Item
							...
							<Form.Item
								...
								tooltip={
									<>
										...
										<Button type='primary' onClick={() => restoreImage()}>
											{'Cambiar a Imagen Original'}
										</Button>
									</>
								}
							/>
							<Image src={image} alt={'Imagen Certificado'} />
						</Col>
					</Row>
