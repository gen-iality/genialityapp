...
const initContent =
  '<p><br></p><p><br></p><p>Certificamos que</p><p>[user.names],</p><p>participo con éxito de curso</p><p>[event.name]</p><p>realizado del [event.start] al [event.end].'; /* </p><p>[event.venue], información.</p> */
