			...
			reader.onload = async (e) => {
				...
				if (sheetObj['!ref']) {
					...
					if (emailList.length > remainingCapacity) {
						Modal.warning({
							title: 'Advertencia: Capacidad del Evento Superada. Ajusta tu Lista de Usuarios antes de Importar',
							content: `La cantidad de usuarios que estás intentando importar (${emailList.length}) excede la capacidad disponible restante para el evento (${remainingCapacity}). Por favor, ajusta la lista de usuarios y vuelve a intentarlo.`,
						});
						return;
					}
