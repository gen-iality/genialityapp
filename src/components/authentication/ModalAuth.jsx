...
import { Modal, Tabs, Form, Input, Button, Divider, Typography, Space, Grid, Alert, Image, Row } from 'antd';
	...
	return (
		modalVisible && (
			<Modal
				...
				{isPayment && (
					<Alert
						message='Para comprar el ticket primero debes Iniciar sesión o Registrarte'
						type='warning'
						style={{ marginTop: 15 }}
						closable={false}
						banner
