import { Card, Col, Drawer, Row, Tabs, Grid, Button, Space, Image } from 'antd';
						...
						<Col span={24}>
							<Card style={{ borderRadius: '20px' }} bordered={false} bodyStyle={{ padding: '0px 20px' }}>
								<Tabs defaultActiveKey='1' draggable style={{ width: '100%' }} tabBarStyle={{ margin: '0px' }}>
									...
									<Tabs.TabPane key='3' tab='Plantilla'>
										<Row>
											<Col span={24}>
												<Card>
													<Space>
														{!!dataFirebaseBingo?.template?.image && (
															<Image src={dataFirebaseBingo?.template?.image} width={150} height={150} />
														)}
													</Space>
												</Card>
											</Col>
