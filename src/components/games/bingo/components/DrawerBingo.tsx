import { Card, Col, Drawer, Row, Tabs, Grid, Button, Space, Image, Typography } from 'antd';
    ...
    <Drawer
      ...
      <Row gutter={[16, 8]} style={{}}>
        ...
        <Col xs={24} sm={24} md={24} lg={14} xl={14} xxl={14} style={{}}>
          <Row gutter={[16, 16]}>
            <Col xs={24} sm={24} md={24} lg={18} xl={18} xxl={18} style={{}}>
              <BingoCard
            ...
            <Col xs={24} sm={24} md={24} lg={6} xl={6} xxl={6} style={{ padding: '5px' }}>
