...
import { Bingo, BingoGame, BingoPrintProps, DimensionInterface } from '@/components/games/bingo/interfaces/bingo';
import {
	CreateBingo,
	DeleteBingo,
	GetBingo,
...
export const useBingo = () => {
	...
	const [dataFirebaseBingo, setDataFirebaseBingo] = useState<BingoGame>({
		template: null,
		bingoData: [],
