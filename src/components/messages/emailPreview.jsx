    ...
    <div >
      <div style={{textAlign: 'center'}}>
        ...
        <p className='has-text-primary'>
          <EnvironmentOutlined />
          Ubicación del evento<br />{props.event.location.FormattedAddress}
          <Tag color='#1cdcb7' style={{fontSize: '14px'}}>Confirmar asistencia</Tag>
        </p>
        <Image
          width={400}
          src={props.item.image ? props.item.image : props.event.image} alt={'Imagen Perfil'}
        />
