...
export function QuizProgressPage(props: IQuizProgressPageProps) {
  return (
    <div>
      <Typography.Title>Quiz progress</Typography.Title>
      <QuizProgress eventId={eventId} surveyId={surveyId} userId={userId} />
      <hr />
      <QuizzesProgress eventId={eventId} userId={userId} />
    </div>
  )
}
