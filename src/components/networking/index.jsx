...
class ListEventUser extends Component {
            ...
            */
            this.userListener = usersRef.orderBy("updated_at", "desc").onSnapshot({
                ...
                this.setState((prevState) => {
                    const usersToShow = (ticket.length <= 0 || stage.length <= 0) ? [...newItems].slice(0, 100) : [...prevState.users];
                    return {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <EventContent className="columns">
                                            ...
                                            <Row key={key}>
                                                <Card className="event-description" title={users.properties.names ? users.properties.names : "No registra Nombre"} bordered={true} style={{ width: 600, marginTop: "2%", marginBottom: "2%" }}>
                                                    ...
                                                    <Col Span={6}>
                                                        ...
                                                        <p>Telefono: {users.properties.phone ? users.properties.phone : "No registra Telefono"}</p>
                                                    </Col>
