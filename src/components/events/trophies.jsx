                                ...
                                <Row gutter={[12, 12]} align="middle">
                                    <Col xs={24} sm={24} md={12} lg={8} xl={8}>
                                        <div className="imagen">
                                          ...
                                          <h1>Smartwatch</h1>
                                          <img style={{cursor:'pointer'}} src="https://firebasestorage.googleapis.com/v0/b/eviusauth.appspot.com/o/image1.jpg?alt=media&token=1c8eef7b-7ad2-4dc6-b34a-59502529b44a" />
                                        </div>
                                   </Col>
                                   <Col xs={24} sm={24} md={12} lg={8} xl={8}>
                                        <div className="imagen">
                                          ...
                                          <img style={{cursor:'pointer'}} src="https://firebasestorage.googleapis.com/v0/b/eviusauth.appspot.com/o/image2.jpg?alt=media&token=8e488dea-24e5-4419-bd13-6d906dd1ef50" />
                                        </div>
                                   </Col>
                                   <Col xs={24} sm={24} md={12} lg={8} xl={8}>
                                        <div className="imagen">
                                          ...
                                          <img  style={{cursor:'pointer', height: "389px"}} src="https://firebasestorage.googleapis.com/v0/b/eviusauth.appspot.com/o/imagePowerBank.jpg?alt=media&token=d97429d1-a938-4286-9778-6c393c73c5cb" />
                                        </div>
                                   </Col> 
