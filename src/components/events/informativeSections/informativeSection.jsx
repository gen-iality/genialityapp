            ...
            {this.state.galeries.map((galery)=>
              ...
              //  ]}
               ...
               />
                ...
                <Modal width={700} okText='Ofrecer' cancelText='Cancelar' centered title={this.state.selectedGalery!=null && this.state.selectedGalery.name} visible={this.state.isModalVisible} onOk={this.handleOk} onCancel={this.handleCancel}>
                 <Row gutter={[12,12]}>
                   <Col span={10}>
                 ...
                 <Col span={12}>
                    ...
                    <Row gutter={[12,12]}> 
                      ...
                      <Alert style={{padding:'4px 15px'}} type="success" message={this.state.selectedGalery!=null && '$ '+this.state.selectedGalery.price} />  
                      </Col>
                      <Col span={12}> 
