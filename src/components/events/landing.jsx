...
//custom
import API, { Actions, EventsApi, TicketsApi, fireStoreApi, Activity, getCurrentUser } from '../../helpers/request';
...
class Landing extends Component {
  ...
  async componentDidMount() {
    ...
    const sections = {
      agenda: (
        <AgendaForm event={event} eventId={event._id} toggleConference={this.toggleConference} currentUser={user} />
      ),
      tickets: (
        <>
