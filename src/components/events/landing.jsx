                                    ...
                                    <ComponentSlider
                                        ...
                                        >
                                            ...
                                            <li className="items menu-item"  className={this.state.section == 'certs' ? 'items menu-item nav-item-active' : 'items menu-item nav-item'} onClick={e => { this.showSection('certs') }}>
                                             ...
                                             <li className="items menu-item"  className={this.state.section == 'documents' ? 'items menu-item nav-item-active' : 'items menu-item nav-item'} onClick={e => { this.showSection('') }}>
