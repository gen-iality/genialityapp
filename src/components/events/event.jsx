                                    ...
                                    (!this.state.newEvent) && (
                                        <div className={`${showMenu?'is-hidden-mobile':''}`}>
                                            <p className="menu-label">
                                                <NavLink className="item" onClick={this.handleClick}
                                            ...
                                            </p>
                                            {
                                                this.state.userTab && (
                                                    <ul className="menu-list">
                                                        <li>
                                                            <NavLink onClick={this.handleClick} activeClassName={'active'} to={`${match.url}/rsvp`}>Enviar</NavLink>
                                                        </li>
                                                        <li>
                                                            <NavLink onClick={this.handleClick} activeClassName={'active'} to={`${match.url}/messages`}>Historial</NavLink>
                                                        </li>
                                                    </ul>
                                                )
                                            }
                                            <p className="menu-label">
                                                <NavLink onClick={this.handleClick} className="item" activeClassName={'active'} to={`${match.url}/assistants`}>Asistentes</NavLink>
                                            </p>
                                        ...
                                        <i className={`${this.state.contentTab?'up':'down'}`}/>
                                            ...
                                            </p>
                                            {
                                                this.state.contentTab && (
                                                    <ul className="menu-list">
                                                        <li>
                                                            <NavLink onClick={this.handleClick} activeClassName={'active'} to={`${match.url}/agenda`}>Agenda</NavLink>
                                                            <NavLink onClick={this.handleClick} activeClassName={'active'} to={`${match.url}/agenda`}>Speakers</NavLink>
                                                        </li>
                                                    </ul>
                                                )
                                            }
