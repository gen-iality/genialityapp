...
class AdminRol extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <EventContent title={"Organizadores"} description={"Registre las personas que serán parte de la logística de su evento"}
                                addAction={this.handleModal} addTitle={"Agregar staff"}>
