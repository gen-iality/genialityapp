...
class General extends Component {
  ...
  async componentDidMount() {
    ...
    if (
      (this.state.event.visibility === 'PUBLIC' ||
        this.state.event.visibility === 'ANONYMOUS') &&
  ...
  changeDate = (value, name) => {
    ...
    if (name === 'date_start') {
      ...
      if (diff >= 0) date_end = dayjs(date_end).add(diff, 'days').toDate()
      this.setState({
        minDate: value,
              ...
              <Row justify="center" wrap gutter={[8, 8]}>
                <Col span={16}>
                  ...
                  <Card title="Zona social">
                    ...
                    <Row style={{ padding: '8px 0px' }}>
                      <Col xs={18}>
                        Mantener la zona social desplegada cada vez que se ingresa a una
                        actividad
                      </Col>
                      <Col xs={6}>
                        <Switch
