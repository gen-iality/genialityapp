          ...
          return (
            <div key={`g${key}`} name='field'>
              <Form.Item
                ...
                htmlFor={key}
                initialValue={value}>
                <Checkbox {...props} key={key} name={name} defaultChecked={!!value}>
                ...
                <span className='fieldlabel'>
                  ...
                  {description.length < 500 ? (
                    ...
                    <Collapse defaultActiveKey={['0']} style={{ marginBottom: '15px' }}>
                      <Panel header={`${getShortDescription(description)}... Ver más`} key='1'>
                        <pre dangerouslySetInnerHTML={{ __html: description }} style={{ whiteSpace: 'normal' }} />
                      </Panel>
                    </Collapse>
                  )}
                </span>
                ...
                {errorRegisterUser && (
                  <Col span={24} style={{ display: 'inline-flex', justifyContent: 'center' }}>
                    <Alert
                      ...
                      message={'Ya te encuetras registrado en magnetic'}
                    />
                  </Col>
                )}
