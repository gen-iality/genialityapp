                  ...
                  {editUser && (
                    <Card style={{ borderRadius: '8px' }} bodyStyle={{ padding: '20px' }}>
                      ...
                      {organization ? (
                        <Comment
                          avatar={
                            initialOtherValue.picture ? (
                              <Avatar src={initialOtherValue?.picture} />
                            ) : null
                          }
                          author={
                            <Typography.Text style={{ fontSize: '18px' }}>
                              {initialOtherValue?.names}
                            </Typography.Text>
                          }
                          content={
                            <Typography.Text style={{ fontSize: '18px' }}>
                              {initialOtherValue?.email}
                            </Typography.Text>
                          }
                        />
                      ) : (
                    ...
                    isVisibleButton(basicDataUser, extraFields, cEventUser) ? (
                      <div style={{ textAlign: 'center', width: '100%' }}>
                        {intl.formatMessage({
                          ...
                          defaultMessage:
                            'No hay campos disponibles para actualizar en este curso',
                        })}
                      </div>
                    ) : (
                      <div style={{ textAlign: 'center', width: '100%' }}>
                  ...
                  {!loadingregister && (
                    <Form.Item>
                      <Button
                        ...
                        ref={buttonSubmit}
                        style={{
                          display: isVisibleButton(basicDataUser, extraFields, cEventUser)
                            ? 'none'
                            : 'block',
                        }}
                        // Restricciones
