...
function AgendaActivityItem(props) {
  ...
  const urlactivity =
    cEvent && !cEvent?.isByname
      ? `/landing/${props.event._id}/activity/`
        ...
        >
          ...
          <Col xs={24} sm={24} md={0} lg={0} xxl={0}>
            ...
            <Badge.Ribbon
              ...
              color={
                item.habilitar_ingreso == 'open_meeting_room' ? 'red' : 'transparent'
              }
              text={
                item.habilitar_ingreso == 'open_meeting_room' ? (
                  <Space>
                    ...
                    <Space direction="vertical">
                      <Row gutter={[10, 10]}>
                        <Row span={24} style={{ paddingLeft: '0px' }}>
                          <ActivityCustomIcon
                            style={{ marginTop: '0.3em', marginRight: '10px' }}
                            type={item.type?.name}
                          />
                          <div
                            className="titulo"
                          ...
                          <div className="lesson">
                            <Badge
                              style={{
                                backgroundColor:
                                  activityContentValues.url === item.type?.name
                                    ? '#CB1313'
                                    : [
                                        activityContentValues.streaming,
                                        activityContentValues.rtmp,
                                        activityContentValues.vimeo,
                                        activityContentValues.youtube,
                                        activityContentValues.meeting,
                                        activityContentValues.meet,
                                      ].includes(item.type?.name)
                                    ? '#14AA55'
                              ...
                              count={lessonTypeToString(
                                item.type?.name || 'Contenido genérico',
                              )}
                            />
                          </div>
                          <span
