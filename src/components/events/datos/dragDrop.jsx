...
import { EventFieldsApi, Actions } from "../../../helpers/request";
...
class DragDrop extends Component {
    ...
    async submit() {
        ...
        notification.open({
            ...
            description:
                'El orden de la recopilacion de datos se ha guardado',
            onClick: () => {
    ...
    onDragEnd(result) {
        ...
        if (result.type === "user_properties") {
            const user_properties = Reorder(
                this.state.user_properties,
                result.source.index,
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Button style={{ marginTop: "3%" }} disabled={available} onClick={this.submit}>Guardar orden de Datos</Button>
            </div>
        );
    }
}
