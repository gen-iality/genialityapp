...
const NoticiasDetails = ({ setVirtualConference, match,setTopBanner  }) => {
              ...
              >
                ...
                >
                  <Meta 
                    ...
                    description={noticia && <div dangerouslySetInnerHTML={{ __html: noticia.description_complete }}></div>}
                  />
                </Card>
                <br />
                <Title level={3} style={{textAlign: 'center', textDecoration: 'underline'}}>Ver mas Noticias</Title>
                {/* <br /> */}
