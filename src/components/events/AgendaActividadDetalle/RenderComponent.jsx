    ...
    switch (currentActivity?.platform) {
        ...
        case "zoom":
            switch (currentActivity?.habilitar_ingreso) {
                case "open_meeting_room":
                    if (chatAttendeChats !== "4") {
                        if (props.cEventUser?.value && (currentActivity?.requires_registration || !currentActivity?.requires_registration)) {
                            ComponentRender = <ZoomIframe
