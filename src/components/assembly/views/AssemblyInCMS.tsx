import { Button, Card, Col, Collapse, Result, Row, Space, Statistic, Typography } from 'antd';
	...
	return (
		<div style={{ padding: '40px' }}>
			{!isAssemblyMood ? (
				...
				<Row>
					<Card>
						<Result title='Contenido no disponible' subTitle='Para ingresar a esta sección debes de activar el modo asambleas' />
					</Card>
				</Row>
			)}
		</div>
