            ...
            <Col span={8}>
                ...
                tooltip={{
                  ...
                  title: (
                    <Typography.Text style={{ color: "#fff" }}>
                      Canal o red social basada en videos, permite compartir y
                      almacenar videos digitales para que los usuarios comenten
                      en la página de cada uno de ellos. Los usuarios deben
                      estar registrados para subir videos, crear su perfil y
              ...
              <Form.Item
                ...
                tooltip={{
                  ...
                  title: (
                    <Typography.Text style={{ color: "#fff" }}>
                      Herramienta de transmisión en directo (en vivo) que emite
                      en los canales o red social de tu preferencia que
                      transporta el contenido audiovisual como datos entre
                      codificador y una plataforma de streaming.
                    </Typography.Text>
                  ),
                }}
              >
