...
const WowzaStreamingPanel = ({
  ...
  const livestreamQuery = useQuery(['livestream', meeting_id], () =>
    getLiveStream(meeting_id),
  )
  ...
  function copyToClipboard(type) {
    if (type === 'Productor') {
      ...
      navigator.clipboard.writeText(
        livestreamQuery.data.source_connection_information.primary_server,
      )
      success()
            ...
            {livestreamStatus?.state === 'stopped' ? (
              ...
              <Row justify="space-between">
                <>
                  ...
                  {linkRolAdmin && transmition === 'RTMP' && (
                    <Typography.Title level={5}>RTMP</Typography.Title>
                  )}
                </>
                <Space>
                  <Button
                ...
                {livestreamStats?.connected.value === 'Yes' ? (
                  <Badge.Ribbon text="En transmisión" color="red">
                    <WOWZAPlayer
                      ...
                      thereIsConnection={livestreamStats?.connected.value}
                    />
                  </Badge.Ribbon>
                ) : (
                  <WOWZAPlayer
                    ...
                    <>
                      ...
                      <Input.Group compact>
                        <Input
                          ...
                          disabled
                          value={
                            livestreamQuery.data.source_connection_information
                              .primary_server
                          }
                        />
