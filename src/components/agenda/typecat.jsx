...
class AgendaTypeCat extends Component {
    ...
    removeNewItem = () => this.setState(state => ({list:state.list.filter(({_id}) => _id !== "new"),id:"",name:""}));
                                    ...
                                    subject === "categorias" && <td>
                                        {
                                            id === object._id ?
                                                ...
                                                <div style={{padding: '5px', width: '36px', height: '14px', background: object.color, borderRadius: '1px', boxShadow: '0 0 0 1px rgba(0,0,0,.1)'}}/>
                                        }
                                    </td>
                                }
                                <TableAction id={id} object={object} saveItem={this.saveItem} editItem={this.editItem}
                                    removeNew={this.removeNewItem} removeItem={this.removeItem} discardChanges={this.discardChanges}/>
                            </tr>
                        })}
                    </EvenTable>
                }
