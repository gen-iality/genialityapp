      ...
      <div onClick={() => selectOption(id)} style={borderStyles}>
        <Card
          ...
          style={{
            width: '100%',
            borderRadius: '8px',
            minHeight: (description ? description.length : 0) > 0 ? '333px' : 'auto',
          }}
          cover={
            <img
              ...
              src={
                image ||
                'https://img.freepik.com/vector-gratis/plantilla-banner-contraccion-conexion_52683-42130.jpg'
              }
              height={150}
            />
          }
        >
          <Card.Meta
            ...
            description={
              <Typography.Paragraph type="secondary" style={{ userSelect: 'none' }}>
                {description}
