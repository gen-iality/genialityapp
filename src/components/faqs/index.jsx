        ...
        return (
            <div className="columns is-mobile">
                <div className="column is-half is-offset-one-quarter">
                    ...
                    <p>En la tienda virtual de (INCLUIR NOMBRE DEL COMERCIO) usted podrá realizar su pago con los medios habilitados para tal fin. Usted, de acuerdo a las opciones de pago escogidas por el comercio, podrá pagar a través de PSE (débitos desde cuentas de ahorros y corrientes en Colombia), tarjetas de crédito Visa, MasterCard, American Express, Credencial y Diners; Tarjeta Éxito, Tarjeta Alkosto,  débitos internacionales a través de Safety Pay o acercándose a un punto de Western Union en cualquier lugar del mundo.
                    ...
                    <p>En primera instancia, revisar si llegó un email de confirmación de la transacción a la cuenta de correo electrónico inscrita en el momento de realizar el pago, en caso de no haberlo recibido, deberás contactar a (PERSONA RESPONSABLE AL INTERIOR DEL COMERCIO) para confirmar el estado de la transacción.</p>
                    ...
                    <p>Si no lo recibes, podrás contactar a (PERSONA RESPONSABLE AL INTERIOR DEL COMERCIO) o a la línea (teléfono del comercio) o al correo electrónico comercio@comercio.com, para solicitar el reenvío del comprobante a la misma dirección de correo electrónico registrada al momento de pagar.</p>
                </div>
            </div>
        );
    }
