...
export const ChangePassword = ({ email }) => {
  ...
  const [passwordSentSuccessfullyOrWrongly, setPsswordSentSuccessfullyOrWrongly] =
    useState('initial')
    ...
    <Card style={{ borderRadius: '15px' }}>
      ...
      <div style={{ padding: '24px' }}>
        <Typography.Paragraph type="success" style={{ fontSize: '15px' }}>
          Puede solicitar un cambio de contraseña haciendo clic en el botón
          &quot;Solicitar cambio&quot;. Le enviaremos un correo electrónico con
